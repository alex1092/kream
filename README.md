...
The first thing that was done was brainstorming Ideas.  Once the marketplace idea was thought of, I used Trello to break down each aspect of the project.  After using Trello to plan what was needed for the site, I drew up wireframes so I could visualise what it was going to look like.  After that I created my erd so I could visualise my Database.  Using devise and bootstrap I was able to quickly create authentication.  Once authentication was complete, I then worked on the product model.  To create the product model, I used the rails g scaffold command.  I then created the necessary migrations to reference the two models to each other.  I then worked on overall styling of the website created a nav bar and a root page.  I then used various bootstrap techniques to speed up the process of my front-end design. Using the stripe Api and various tutorials on the internet I enable a payment gateway with stripe.  Then using the steps provided in the rolify git hub I created authorization and restricted some views to users.  I then created a message feature so users could communicate.  Then I set up and administrators’ dashboard which used a graph gem that utilizes JavaScript to track the growth of the site.  Using omniauth I created a Facebook Omniauth link.  Then I deployed the final product to Heroku

[Link To Trello Screenshots](docs/trello-img.png)

[Link To Live Trello](https://trello.com/b/YSEcawlI/kream)
...
[Screenshot For Mobile Index](docs/screenshot/index-screenshot-mobile.png)

[Screenshot For Dashboard](docs/screenshot/dashboard_screen.jpg)

[Screenshot For New Product](docs/screenshot/new-prodcut-screen.png)

[Screenshot For All Products](docs/screenshot/screenshot-prodcuts.png)

[Screenshot For Chat](docs/screenshot/chat-screenshot.png)

[Screenshot For index Desktop](docs/screenshot/screenshot-index-kream.jpg)
[Screenshot For Chat Desktop](docs/screenshot/chat-screenshot.png)
