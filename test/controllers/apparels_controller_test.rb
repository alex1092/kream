...
class ApparelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apparel" do
    assert_difference('Apparel.count') do
      post apparels_url, params: { apparel: { brand: @apparel.brand, model: @apparel.model, price: @apparel.price, size: @apparel.size } }
    end
  ...
  test "should update apparel" do
    patch apparel_url(@apparel), params: { apparel: { brand: @apparel.brand, model: @apparel.model, price: @apparel.price, size: @apparel.size } }
